...
python evaluation.py ~/PROJECTS_MP/datasets/dataset_100/interpolated.csv ~/PROJECTS_MP/hea_ml.git/prediction_10k_b75/denormalized_100.csv ~/PROJECTS_MP/hea_ml.git/prediction_10k_b75/rms_100.csv
