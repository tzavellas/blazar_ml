...
if __name__ == "__main__":
    ...
    history = model.fit(train_full[0], train_full[1], epochs=120, validation_split=.2,
                        callbacks=[keras.callbacks.TensorBoard('./logs/rnn', update_freq='epoch')])
    ...
    save_path = os.path.join(working_dir, 'hea_rnn.h5')
